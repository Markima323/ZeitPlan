...
SCHEDULED_WAKE_WIFI_WAIT_SECONDS="120"
SCHEDULED_WAKE_PREVENT_SUSPEND="1"
SCHEDULED_WAKE_PULL_RETRIES="4"
SCHEDULED_WAKE_EVENT_RETRIES="2"
SCHEDULED_WAKE_RETRY_DELAY_SECONDS="10"
SCHEDULED_WAKE_SLEEP_AFTER_UPDATE="1"
SCHEDULED_WAKE_SLEEP_DELAY_SECONDS="8"
LOCKSCREEN_ONLY_TTL_SECONDS="300"
