...
- UI 风格延续了根目录 `plan.jsx / plan.css` 的暖色玻璃卡片方向
- 这里把“在列之间插入/删除”落成了“在任务块之间插入/删除”，同时保留右侧表格式时间预览
- 骰子规则在后端做了强约束：默认只能对“今天”并且“17:00 之后”的计划投掷
- 开发模式里开启了 `APP_DICE_TEST_MODE=true`，方便本地调试投骰子流程
